      ...
      <div className="container mx-auto px-6">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="relative">
            <div className="absolute left-8 top-0 bottom-0 w-0.5 bg-gradient-to-b from-amber-500 to-yellow-600"></div>
            
            {experiences.map((exp, index) => (
              <div key={index} className="relative flex items-start mb-12">
                <div className="absolute left-6 w-4 h-4 bg-gradient-to-r from-amber-500 to-yellow-600 rounded-full"></div>
                
                <div className="ml-16 bg-gradient-to-br from-amber-50 to-yellow-50 rounded-xl p-6 md:p-8 shadow-lg w-full">
                  <div className="flex flex-col lg:flex-row lg:justify-between lg:items-start mb-4">
                    <div>
                      <h3 className="text-xl font-bold text-gray-800 mb-1">{exp.role}</h3>
                      <h4 className="text-lg font-semibold text-amber-600 mb-2">{exp.company}</h4>
                    </div>
